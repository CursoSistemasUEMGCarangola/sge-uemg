...
```mermaid
graph TD
    E1[Etapa 1: Capa & Documentos Físicos] -->|Professor aprova| E2[Etapa 2: Conferência de Dados]
    E2 -->|Professor aprova| E3[Etapa 3: Assinaturas Institucionais]
    E3 -->|Professor aprova| E4[Etapa 4: Diário de Atividades & Plano]
    E4 -->|Professor aprova| E5[Etapa 5: Conferência do Plano]
    E5 -->|Professor aprova| E6[Etapa 6: Relatório Final]
    E6 -->|Professor aprova| E7[Etapa 7: Conferência do Relatório]
    E7 -->|Professor aprova| E8[Etapa 8: Verificação Final]
```
